...
class ExtensionBundle:
    ...
    """Developer URL. Must begin with `http(s)://`."""
    developerURL: Optional[str] = None

    """Boolean specifying if the extension should be launched at RoboFont startup."""
    launchAtStartUp: Optional[bool] = None

    """Python script run during extension launch."""
    ...
    """The documentation can be stored online and accessed through a URL. If specified it must start with `http(s)://` v4"""
    documentationURL: Optional[str] = None

    """"""
    uninstallScript: Optional[str] = None  # v2

    """The timestamp is automatically generated by the class when an extension is saved on disk."""
    timeStamp: Optional[float] = None

    """The hash is automatically generated by the class when an extension is saved on disk."""
    hash: str = ""

    """RoboFont major version number required to run this extension."""
    requiresVersionMajor: Optional[str] = None

    """RoboFont minor version number required to run this extension."""
    requiresVersionMinor: Optional[str] = None

    """Extension expire date, if set use the format YYYY-MM-DD"""
